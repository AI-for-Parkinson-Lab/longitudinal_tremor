%% Step 9: Assess responsiveness to dopaminergic treatment initiation
clear all; close all;
...
tremor_time_before_start = trend_tremor_time_unmedicated_filled;
tremor_time_after_start = trend_tremor_time_medicated_filled(1+length(IDs_BaselineMedicated):end,:);
modal_tremor_power_before_start = trend_modal_tremor_power_unmedicated_filled;
modal_tremor_power_after_start = trend_modal_tremor_power_medicated_filled(1+length(IDs_BaselineMedicated):end,:);
perc90_tremor_power_before_start = trend_perc90_tremor_power_unmedicated_filled;
perc90_tremor_power_after_start = trend_perc90_tremor_power_medicated_filled(1+length(IDs_BaselineMedicated):end,:);

include_idx = find(~all(isnan(tremor_time_after_start),2));

IDs_StartMedication_include = IDs_BaselineUnmedicated(include_idx);
